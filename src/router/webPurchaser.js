// 个人中心路由
export let webPurchaserRoute = [{
    path: 'webPersonalCenterHome', //首页
    name: 'webPersonalCenterHome',
    meta: {
      hideInMenu: true,
      title: '首页',
      notCache: true,
    },
    component: () => import( /* webpackChunkName: "webPersonalCenterHome" */ '../views/webPersonalCenter/webPersonalCenterHome.vue'),
  },
  {
    path: 'purchaserHome',
    name: 'purchaserHome',
