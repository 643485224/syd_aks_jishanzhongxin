      ...
      >
        ...
        <template slot="operate" slot-scope="value">
          ...
          <el-button
            type="text"
            class="warning-btn"
            @click="deleteRole(value.value.id, 1)"
            >删除</el-button
          >
        </template>
      </cu-table>
    ...
    >
      ...
      >
        <template v-slot:menuId="value">
          <cu-tree
            :checkStrictly.sync="checkStrictly"
            :treeList="menuData"
            :propsRule="value.value.propsRule"
            :defaultCheckedKeys="roleMenuKeys"
            @getCheckedKeys="getCheckedMenuKeys(arguments[0], value.form)"
            nodeKey="id"
          >
          </cu-tree>
        </template>
    ...
    async showForm(type, roleId) {
      ...
      if (res.code == 200) {
        ...
        if (type == "edit") {
          ...
          if (
            haveMenusRes &&
            haveMenusRes.code == 200 &&
            haveMenusRes.data &&
            haveMenusRes.data.length
          ) {
...
<style lang="scss" src="./roleManagement.scss" scoped></style>
