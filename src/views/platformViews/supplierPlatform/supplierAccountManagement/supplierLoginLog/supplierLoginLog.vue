  ...
  <div class="page-container table-page" ref="contentBox">
    <div class="search-bar">
      <div class="search-item">
        操作：
        <el-input class="selectInput" v-model="operType" placeholder="请输入操作方式">
        </el-input>
      </div>
      <div class="search-item">
        用户：
        <el-input class="selectInput" v-model="operBy" placeholder="请输入用户名称">
        </el-input>
      </div>
      <div class="search-item">
        创建时间：
        <!--   :default-time="['00:00:00', '23:59:59']" -->
        <el-date-picker v-model="date" @change="pickDate" format="yyyy-MM-dd HH:mm:ss" type="datetimerange"
          range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期">
        </el-date-picker>
      </div>
      <div class="search-item">
        <el-button class="operation-btn bgOrange" type="primary" @click="search">查询</el-button>
        <el-button class="operation-btn bgGreen" type="primary" @click="exportXls">导出</el-button>
      </div>
    </div>
...
import { loginLogQuery, logExportXls } from "@/api/aksApi/platformApi/supplierPlatformApi.js";
...
<style lang="scss" src="./supplierLoginLog.scss" scoped>
