    ...
    <div class="page-container table-page" ref="contentBox">
        <div class="search-bar">
            <div class="search-item">
                操作：
                <el-input class="selectInput" v-model="operateType" placeholder="请输入操作方式">
                </el-input>
            </div>
            <div class="search-item">
                用户：
                <el-input class="selectInput" v-model="operateBy" placeholder="请输入用户名称">
                </el-input>
            </div>
            <div class="search-item">
                创建时间：
    ...
    methods: {
        ...
        getLoginLogList() {
            ...
            let params = {
                ...
                operType: this.operateType,
                operBy: this.operateBy,
                // sysId: this.sysId,
