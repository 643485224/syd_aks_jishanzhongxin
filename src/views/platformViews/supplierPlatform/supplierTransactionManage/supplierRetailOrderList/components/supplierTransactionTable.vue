    ...
    <div>
        ...
        <cu-table class="sale-table" :loading="tableLoading" :height="height" :showTitle="false"
            ...
            <template slot="operate" slot-scope="value">
                ...
                <el-button type="text" class="orange" @click="responseOrder(value.value.id)"
                ...
                <el-button type="text" class="orange" @click="ship(value.value.orderNo)" v-if="value.value.status == 2">
                    发货</el-button>
                <el-button type="text" class="orange" @click="audit(value.value.id)" v-if="value.value.status == 10">审核
                </el-button>
...
export default {
    ...
    methods: {
        ...
        showDetails(orderId,orderNo) {
            console.log(orderNo);
            this.$router.push(`./supplierTransactionOrderDetails/${orderId}/${orderNo}`)
        },
        operation(type,id) {
            this.orderId = id;
        ...
        ship(orderNo) {
            ...
            // }).then(({ value }) => {
            //     goodsShipped({ orderNo, expressNumber: value }).then(res => {
            //         console.log(res);
            //         if (res.code == 200) {
            //             this.$message.success("发货成功")
            //             this.getOrderList()
