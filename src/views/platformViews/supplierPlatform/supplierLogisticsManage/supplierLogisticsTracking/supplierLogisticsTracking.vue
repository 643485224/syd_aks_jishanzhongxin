<template>
  <div class="page-container table-page" ref="contentBox">
    ...
    <cu-animation :type="'slideInRight'" :time=".5">
      <cu-table class="sale-table" :selection="true" :loading="tableLoading" :height="tableHeight" :showTitle="false"
        ...
        <template slot="operate" slot-scope="value">
          <el-button type="text" @click="showDetails(value.value.orderNo)">查看物流</el-button>
        </template>
      </cu-table>
    </cu-animation>
    <cu-dialog title="查看物流" width="70vw" :visible="dialogVisible" :showClose="true" @handleClose="handleClose"
      ...
      <div class="logistics-details">
        <div class="info">
          ...
          <div class="stage">
            <div class="stage-item" v-for="(item, index) in logisticsData.logisticsHistoryList" :key="index">
...
import { getLogisticsList, getLogisticsDetail, logisticsExportXls } from "@/api/aksApi/platformApi/supplierPlatformApi.js";
...
export default {
  ...
  methods: {
    ...
    getLogisticsData(orderNo) {
      ...
      console.log(params);
      this.logisticsData = {};
      getLogisticsDetail(params).then(res => {
        console.log(res);
        if (res.code == 200) {
          let data = res.data;
