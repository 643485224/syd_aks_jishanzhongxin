<template>
  <div class="page-container table-page">
    ...
    <cu-dialog :title="'修改手机号'" width="50vw" :visible="phoneVisible" :showClose="true"
    ...
    <cu-dialog :title="'修改密码'" width="50vw" :visible="passVisible" :showClose="true" @handleClose="passVisible = false">
      <!-- :destroyOnClose="true" @menuListInitData="menuListInitData"-->
...
<script>
import { getSupplier, updatePhone,updateAccount } from "@/api/aksApi/platformApi/supplierPlatformApi.js";
