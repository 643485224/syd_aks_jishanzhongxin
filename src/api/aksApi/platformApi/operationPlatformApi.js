...
export const getJyeYearZfqs = (params = {}) => {
  return http.get(`${baseURL}/manager/yytj/getJyeYearZfqs`, {
    params
  }).then(res => res.data)
};
...
export const getJyQysSsbl = (params = {}) => {
  return http.get(`${baseURL}/manager/yytj/getJyQysSsbl`, {
    params
  }).then(res => res.data)
};
...
export const getBjfwList = (params = {}) => {
  return http.get(`${baseURL}/manager/yytj/getBjfwList`, {
    params
  }).then(res => res.data)
};
...
export const wareHouseList = (params = {}) => {
  return http.get(`${baseURL}/manager/kftj/getWarehouseList`, {
    params
  }).then(res => res.data)
};
...
export const getGltjData = (params = {}) => {
  return http.get(`${baseURL}/manager/homepage/getGltjData`, {
    params
  }).then(res => res.data)
};
// 首页 => 首页概览 => 年度采购趋势
export const getCgqsList = (params = {
  beginMonth: '2022-01',
  endMonth: '2022-07'
}) => {
  return http.get(`${baseURL}/manager/homepage/getCgqsList`, {
    params
  }).then(res => res.data)
};
// 首页 => 首页概览 => 药品排行前20
export const getDrug30Top20 = (params = {}) => {
  return http.get(`${baseURL}/manager/homepage/getDrug30Top20`, {
    params
  }).then(res => res.data)
};
// 首页 => 首页概览 => 器械排行前20
export const getApparatus30Top20 = (params = {}) => {
  return http.get(`${baseURL}/manager/homepage/getApparatus30Top20`, {
    params
  }).then(res => res.data)
};
...
export const getSettleStatData = (params = {}) => {
  return http.get(`${baseURL}/manager/homepage/getSettleStatData`, {
    params
  }).then(res => res.data)
};
...
export const tradeOrderList = (params = {}) => {
  return http.get(`${baseURL}/manager/order/orderQuery`, {
    params
  }).then(res => res.data)
};
// 交易管理 => 订单详情
export const tradeorderInfo = (params = {}) => {
  return http.get(`${baseURL}/manager/order/orderInfo`, {
    params
  }).then(res => res.data)
};
...
export const logisticsQuery = (params = {}) => {
  return http.get(`${baseURL}/manager/logistics/logisticsQuery`, {
    params
  }).then(res => res.data)
};
...
export const orderLogisticsList = (params = {}) => {
  return http.get(`${baseURL}/manager/logistics/orderLogisticsList`, {
    params
  }).then(res => res.data)
};
...
export const waitAssignOrderQuery = (params = {}) => {
  return http.get(`${baseURL}/manager/logistics/waitAssignOrderQuery`, {
    params
  }).then(res => res.data)
};
...
export const assignCar = (params = {}) => {
  return http.post(`${baseURL}/manager/logistics/assignCar`, {
    params
  }).then(res => res.data)
};
...
export const getDriverList = (params = {}) => {
  return http.get(`${baseURL}/manager/logistics/getDriverList`, {
    params
  }).then(res => res.data)
};
...
export const getFreeCarList = (params = {}) => {
  return http.get(`${baseURL}/manager/logistics/getFreeCarList`, {
    params
  }).then(res => res.data)
};
...
export const carQuery = (params = {}) => {
  return http.get(`${baseURL}/manager/logistics/carQuery`, {
    params
  }).then(res => res.data)
};
// 物流管理=> 车辆管理 => 新增车辆
...
export const driverQuery = (params = {}) => {
  return http.get(`${baseURL}/manager/logistics/driverQuery`, {
    params
  }).then(res => res.data)
};
...
export const deleteDriver = (params = {}) => {
  return http.delete(`${baseURL}/manager/logistics/deleteDriver`, {
    params
  }).then(res => {
    console.log(res)
    return res.data;
...
export const settleWaitAuditList = (params = {}) => {
  return http.get(`${baseURL}/manager/audit/settle/settleWaitAuditList`, {
    params
  }).then(res => res.data)
};

// 审核管理=> 入驻审核 => 入驻详情
export const settleDetail = (id) => {
  return http.get(`${baseURL}/manager/audit/settle/settleDetail?${Qs.stringify(id)}`).then(res => res.data)
};
...
// 审核管理=> 美食管理 => 美食待审核列表
export const waitAuditList = (params = {}) => {
  return http.get(`${baseURL}/manager/audit/food/waitAuditList`, {
    params
  }).then(res => res.data)
};
// 审核管理=> 美食管理 => 美食分类列表
export const auditselect = (params = {}) => {
  return http.get(`${baseURL}/manager/audit/food/select`, ).then(res => res.data)
};
// 审核管理=> 美食管理 => 批量审核通过
export const fooDbatchAuditPass = (params = []) => {
  let str = Qs.stringify(params)
  var re = /\d(?==+)/g
  var s = str.replace(re, 'idList')
  console.log(s);
  return http.get(`${baseURL}/manager/audit/food/batchAuditPass?${s}`).then(res => res.data)
};
// 审核管理=> 美食管理 => 批量审核拒绝
export const fooDbatchAuditRefuse = (params = []) => {
  let str = Qs.stringify(params)
  var re = /\d(?==+)/g
  var s = str.replace(re, 'idList')
  console.log(s);
  return http.get(`${baseURL}/manager/audit/food/batchAuditRefuse?${s}`).then(res => res.data)
};
// 审核管理=> 美食管理 => 通过
export const fooDauditPass = (params = []) => {
  return http.get(`${baseURL}/manager/audit/food/auditPass`, {
    params
  }).then(res => res.data)
};
// 审核管理=> 美食管理 => 拒绝
export const fooDauditRefuse = (params = []) => {
  return http.get(`${baseURL}/manager/audit/food/auditRefuse`, {
    params
  }).then(res => res.data)
};
// 审核管理=> 美食管理 => 详情
export const fooDinfo = (params = []) => {
  return http.get(`${baseURL}/manager/audit/food/info`, {
    params
  }).then(res => res.data)
};
// 审核管理=> 入驻审核 => 入驻通过
...
export const goodsWaitAuditList = (params = {}) => {
  return http.get(`${baseURL}/manager/audit/goods/goodsWaitAuditList`, {
    params
  }).then(res => res.data)
};
...
export const getDrugInfo = (params = {}) => {
  return http.get(`${baseURL}/manager/audit/goods/getDrugInfo`, {
    params
  }).then(res => res.data)
};
// 审核管理=> 商品审核 => 器械详情
export const getApparatusInfo = (params = {}) => {
  return http.get(`${baseURL}/manager/audit/goods/getApparatusInfo`, {
    params
  }).then(res => res.data)
};
...
export const deletWarehose = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/warehouse/delete`, {
    params
  }).then(res => res.data)
};
// 信息管理>信息管理  => 删除仓位
export const deletOpsition = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/warehouse/position/delete`, {
    params
  }).then(res => res.data)
};
// 信息管理>信息管理  => 新增药品分类
...
export const deletDrug = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/drug/category/delete`, {
    params
  }).then(res => res.data)
};
// 信息管理>信息管理  => 药品分类详情获取
...
export const deletDrugManagement = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/drug/delete`, {
    params
  }).then(res => res.data)
};
// 信息管理>信息管理  => 器械分类列表获取
...
export const deletCategoryClass = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/apparatus/category/delete`, {
    params
  }).then(res => res.data)
};
// 信息管理>信息管理  => 药械分类详情获取
...
export const deletApparatus = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/apparatus/delete`, {
    params
  }).then(res => res.data)
};
// 信息管理>信息管理  => 药械分类详情获取
...
export const getbasequery = (params = {}) => {
  return http.get(`${baseURL}/manager/base/parameter/query`, {
    params
  }).then(res => res)
}
// 信息管理>信息管理  => 删除系统参数列表
export const getbasedelete = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/parameter/delete`, {
    params
  }).then(res => res)
};
// 信息管理>信息管理  => 读取系统参数类型
...
export const getquery = (params = {}) => {
  return http.get(`${baseURL}/manager/base/dict/query`, {
    params
  }).then(res => res)
};
// 信息管理>信息管理  => 删除数据字典列表
export const getdelete = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/dict/delete`, {
    params
  }).then(res => res)
};
// 信息管理>信息管理  => 读取数据字典类型
...
export const getsaleCategoryquery = (params = {}) => {
  return http.get(`${baseURL}/manager/base/saleCategory/query`, {
    params
  }).then(res => res)
};
// 信息管理>信息管理  => 删除出药品分类
export const getsaleCategorydelete = (params = {}) => {
  return http.delete(`${baseURL}/manager/base/saleCategory/delete`, {
    params
  }).then(res => res)
};
// 信息管理>信息管理  => 读取选择商城分类
...
export const getsaleCategoryinfo = (params = {}) => {
  return http.get(`${baseURL}/manager/base/saleCategory/info`, {
    params
  }).then(res => res)
};
// 信息管理>关于我们  => 关于我们详情
export const getAboutMeInfo = (params = {}) => {
  return http.get(`${baseURL}/about-me/getAboutMeInfo`).then(res => res)
};
// 信息管理>关于我们  => 关于我们修改
export const modifyAboutMeInfo = (params = {}) => {
  return http.post(`${baseURL}/about-me/modifyAboutMeInfo`, params).then(res => res)
};
// 物业管理>物业费用  => 查询物业费用列表
export const getpropertyquery = (params = {}) => {
  return http.get(`${baseURL}/manager/property/query`, {
    params
  }).then(res => res)
}
// 物业管理>物业费用  => 删除物业费用列表
export const getpropertydelete = (params = {}) => {
  return http.delete(`${baseURL}/manager/property/delete`, {
    params
  }).then(res => res)
};
// 物业管理>物业费用  => 详情物业费用列表
export const getpropertyinfo = (params = {}) => {
  return http.get(`${baseURL}/manager/property/info`, {
    params
  }).then(res => res)
};
// 物业管理>物业费用  => 编辑物业费用列表
...
// 物业管理=> 批量导入商品
export const batchAdd = (list = []) => {
  console.log(list);
  return http.post(`${baseURL}/manager/property/batchAdd`, list).then(res => res.data)
};


export const propertyFeeImportExcelCheck = (list = []) => {
  console.log(list);
  return http.post(`${baseURL}/manager/property/propertyFeeImportExcelCheck`, list).then(res => res.data)
};
// 物业管理>物业费用  => 导出物业费用列表
export const propertyFeeExportXls = (params = {}) => {
  return http.get(`${baseURL}/manager/property/propertyFeeExportXls`, {
    params,
    responseType: "blob",
  }).then(res => res)
};
...
export const supplierQuery = (params = {}) => {
  return http.get(`${baseURL}/manager/customer/supplierQuery`, {
    params
  }).then(res => res)
};
// 用户管理>供应商管理  => 供应商详情
...
export const supplierQueryExportXls = (params = {}) => {
  return http.get(`${baseURL}/manager/customer/supplierQueryExportXls`, {
    params,
    responseType: "blob",
  }).then(res => res)
};
...
export const getbuyerQueryExportXls = (params = {}) => {
  return http.get(`${baseURL}/manager/customer/buyerQueryExportXls`, {
    params,
    responseType: "blob",
  }).then(res => res)
};
...
export const getuserquery = (params = {}) => {
  return http.get(`${baseURL}/manager/sys/user/query`, {
    params
  }).then(res => res)
};
// 用户管理>系统用户  => 监管用户删除
export const delUserById = (params = {}) => {
  return http.delete(`${baseURL}/manager/sys/user/delUserById/${ params }`).then(res => res)
};
// 用户管理>系统用户  => 监管用户编辑
export const updateUser = (params = {}) => {
  return http.put(`${baseURL}/manager/sys/user/updateUser`,
    params
  ).then(res => res)
};
// 用户管理>系统用户  => 监管用户新增
export const saveSysUser = (params = {}) => {
  return http.post(`${baseURL}/manager/sys/user/saveSysUser`,
    params
  ).then(res => res)
};
// 用户管理>系统用户  => 禁用/启用用户信息
export const signUser = (params = {}) => {
  return http.put(`${baseURL}/manager/sys/user/signUser?${ Qs.stringify(params) }`).then(res => res)
};
